...
public class PointRenderer : MonoBehaviour
{
    ...
    #region GenerateMesh
    public void GenerateMesh(bool fromStarck = false)
    {
        ...
        GenerateMeshFromPg(unselected_mesh, selected_mesh, target_mesh, pG, fromStarck);
    }
    
    public void GenerateMeshFromPg(Mesh m_unsel, Mesh m_sel, Mesh[] m_targets, ParticleGroup pG,
        bool loadflagFormStack = false)
    {
    ...
    public void LoadFlagFromStack(ParticleGroup pG)
    {
        ...
        // List<int> pStack = DataStorage.GetpStack().ToList();
        List<int> pStack = new List<int>();
    ...
    //  List<Vector3> unselected;
    //  List<Vector3> selected;
    //  List<List<Vector3>> targets;
    //
    // public void GenerateMeshFromPgPartial(Mesh m_unsel, Mesh m_sel, Mesh[] m_targets, ParticleGroup pG,
    //     Vector3 center, float length, bool loadflagFormStack = true) //
    // {
    //     if (loadflagFormStack)
    //         LoadFlagFromStack(pG);
    //     unselected = new List<Vector3>();
    //     selected = new List<Vector3>();
    //     targets = new List<List<Vector3>>();
    //     for (int i = 0; i < m_targets.Length; i++)
    //     {
    //         targets.Add(new List<Vector3>());
    //     }
    ...
    //     for (int i = 0; i < pG.GetParticlenum(); i++)
    //     {
    //         if (!InsideWIM(pG.GetParticleObjectPos(i), center, length))
    //             continue;
    //         if (pG.GetFlag(i))
    ...
    // public void DisplayMesh(GameObject m_mesh, ParticleGroup pG, bool deleteOld = true)
    // {
    //     LoadFlagFromStack(pG);
    //     List<Vector3> unselected = new List<Vector3>();
    //     List<Vector3> selected = new List<Vector3>();
    ...
    //
    //
    // public void DisplayMeshByKind(GameObject m_mesh, List<Vector3> vs, int matindex) //selected or unselected
    // {
    ...
    // }
    //
    // public bool InsideWIM(Vector3 pos, Vector3 center, float length)
    // {
