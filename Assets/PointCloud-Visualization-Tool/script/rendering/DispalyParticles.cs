     ...
     public class DisplayParticles
    {
        ...
        static public void GenerateMeshFromPg( Mesh m_unsel, Mesh m_sel,Mesh[] m_targets, ParticleGroup pG, bool loadflagFormStack=false)
        {
           ...
           static List<Vector3> unselected ;
           static List<Vector3> selected ;
         static List<List<Vector3>> targets;
         static public void GenerateMeshFromPgPartial(Mesh m_unsel, Mesh m_sel, Mesh[] m_targets, ParticleGroup pG, Vector3 center, float length,bool loadflagFormStack = true)  //
        {
            if (loadflagFormStack)
                LoadFlagFromStack(pG);
