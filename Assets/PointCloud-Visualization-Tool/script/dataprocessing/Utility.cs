    ...
    public class Utility 
    {
        ...
        public static List<int> GetNodesInArea(ParticleGroup pG, DensityField dF, float dRatio, int parIndex)  //Input by particle position,related to the elipse
        {
            ...
            float xmax, xmin, ymax, ymin, zmax, zmin; //�����0��ʼ
            xmax = nodePos.x + sLx;
            xmin = nodePos.x - sLx;
            ymax = nodePos.y + sLy;
            ymin = nodePos.y - sLy;
            ...
            xmax = xmax - pG.XMIN;  //����׃�Q��ȡ�����ڴ�cube��position���ஔ�ڰ�cube��(xmin,ymin,zmin)����(0,0,0)
            xmin = xmin - pG.XMIN;
            ymax = ymax - pG.YMIN;
            ymin = ymin - pG.YMIN;
            zmax = zmax - pG.ZMIN;
            zmin = zmin - pG.ZMIN;
            if (xmax > pG.XMAX - pG.XMIN)//�Д��Ͻ����sL����
       ...
       public static List<int> GetExtendedNodes(List<int> nodes, DensityField dF, ParticleGroup pG) //��ȡ����node���ܱ߰�Χ��ΪMC��׼��
        {
