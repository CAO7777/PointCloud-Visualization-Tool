...
[System.Serializable]
        ...
        // }
          ...
          float [] dens;
          float [] parDens;
            public void KDE(ParticleGroup pG,ComputeShader KDE_Cs,bool loadFromLocal_)
            {
    ...
    public void KDE_LargeGrid(ParticleGroup pG, ComputeShader KDE_Cs, bool loadFromLocal_, int batchSize)//batchSize 64/128
    {
        string path = "Assets/PointCloud-Visualization-Tool/data/field/Texture3D/" + pG.name + "_" + XNUM + "_" + YNUM + "_" + ZNUM + ".asset";
        if (loadFromLocal_ && System.IO.File.Exists(path))
        {
        ...
        public double InterpolateDensity(UnityEngine.Vector3 pos)
        {
    ...
    public float[] LoadFromTexture3D(string datasetName)
    {
        ...
        UnityEngine.Debug.Log("Successfully loaded Texture3D asset from: " + datasetName + " Total pixels: " + pixels.Length);
