        ...
        #region KDE 
          ...
          float [] parDens;
            ...
            public void SaveAsBin(string datasetName)
            {
                ...
                SaveData.FloatsToBytes(Application.dataPath + "/PointCloud-Visualization-Tool/data/" + "/field/Bin/"+datasetName+"_"+XNUM+"_"+YNUM+"_"+ZNUM+".bin",fs);
            ...
            string assetPath = AssetDatabase.GenerateUniqueAssetPath(directoryPath+datasetName+"_"+XNUM+"_"+YNUM+"_"+ZNUM+".asset");
            ...
            UnityEngine.Debug.Log("Export completed. Asset saved at: " + assetPath);
            }
            ...
            FileStream fs = new FileStream(directoryPath+datasetName+"_"+XNUM+"_"+YNUM+"_"+ZNUM+".raw", FileMode.Create, FileAccess.Write);
            byte[] byteArray = new byte[sizeof(UInt32)*GetNodeNum()];
            for (int i = 0; i < GetNodeNum(); i++)
            {
                byte[] bytex = System.BitConverter.GetBytes((UInt32)GetNodeDensity(i));
                bytex.CopyTo(byteArray, sizeof(UInt32)* i);
            }
            fs.Write(byteArray, 0, byteArray.Length);
            UnityEngine.Debug.Log(directoryPath+datasetName+"_"+XNUM+"_"+YNUM+"_"+ZNUM+".raw"+" export completed.");
            }
