...
public class ParticleGroup
{
    ...
    {
        return particleGroup[i].GetColor();
    }
    ...
    {
        return particleGroup[i].GetGradient();
    }
    ...
    {
        return particleGroup[i].GetPrimaryCurvature();
    }
    ...
    {
        return particleGroup[i].GetSecondaryCurvature();
    }
    ...
    {
        particleGroup[i].SetPrimaryCurvature(c);
    }
    ...
    {
        particleGroup[i].SetSecondaryCurvature(c);
    }
    ...
    {
        particleGroup[i].SetColor(color);
    }
